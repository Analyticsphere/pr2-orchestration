...
PR2_TRANSFORMATION_CLOUD_RUN_URL = "https://ccc-pr2-transformation-dev-1061430463455.us-central1.run.app"
...
class StagingTables(StrEnum):
    ...
    BIOSURVEY_V1_CLEANED_LOOPS = f"{PROJECT}.{_DATASET}.bioSurvey_v1_JP"
    CLINICALBIOSURVEY_V1_CLEANED_LOOPS = f"{PROJECT}.{_DATASET}.clinicalBioSurvey_v1_JP"
    COVID19SURVEY_V1_CLEANED_LOOPS = f"{PROJECT}.{_DATASET}.covid19Survey_v1_JP"
